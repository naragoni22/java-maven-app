pipeline {
    ...
    stages {
        ...
        stage('Git clone') {
            steps {
                git branch: 'main', url: 'https://github.com/naragoni22/java-maven-app.git'
            }
        }
        ...
        stage('Docker images/conatiner remove') {
            steps {
                script{
                        ...
                        docker rmi javamavenapp naresh20/javamavenapp:latest'''
                }  
            }
        }
            ...
            steps {
                script{
                    withDockerRegistry(credentialsId: 'docker', toolname: 'docker'){
                        ...
                        docker push  naresh20/javamavenapp:latest'''
                      } 
                }
            }
        }
        stage('docker container of app') {
            steps {
               sh 'docker run -d -p 9000:8080 --name javamavenapp_container -t naresh20/javamavenapp:latest'
            }
        }
